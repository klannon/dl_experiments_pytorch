...
parser.add_argument('-s','--start-node',
                        type=int, help='Number of nodes in the second hidden layer to start with during model generation')

parser.add_argument('-e','--end-node',
                        type=int, help='Number of nodes in the second hidden layer to stop at in model generation')

parser.add_argument('-i','--node-interval',
                        default=1, type=int, help='Step size for number of nodes in the second hidden layer in model generation')
...
hl2_nodes = np.arange(args.start_node, args.end_node + args.node_interval, args.node_interval)
