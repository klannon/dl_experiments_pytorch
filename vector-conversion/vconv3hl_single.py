...
parser.add_argument('-l3','--layer3-nodes',
                        type=int, help='Number of nodes in the third hidden layer')
...
layer_3 = nn.Linear(int(hl2_nodes), int(hl3_nodes))  
...
layer_4 = nn.Linear(int(hl3_nodes), int(3))  
...
for trial in range(trials):
    ...
    print('Training complete: {}, {}, {} node model, trial {}'.format(hl1_nodes,hl2_nodes,hl3_nodes,trial))
